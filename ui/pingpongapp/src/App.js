...
import { ProcedureServiceClient } from "./proto/procedures_grpc_web_pb";
import { GetProceduresRequest } from "./proto/procedures_pb";

// We create a client that connects to the api
var client = new ProcedureServiceClient("https://localhost:31880");
